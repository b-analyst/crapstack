...
from crapstack.haystack.modeling.evaluation.metrics import semantic_answer_similarity

from crapstack.haystack.pipelines.config import (
...
from crapstack.haystack.pipelines.utils import generate_code, print_eval_report
from crapstack.haystack.schema import EvaluationResult, MultiLabel, Document
from crapstack.haystack.errors import HaystackError, PipelineError, PipelineConfigError, DocumentStoreError
from crapstack.haystack.nodes.answer_generator import BaseGenerator
from crapstack.haystack.nodes.reader import BaseReader
from crapstack.haystack.nodes.other import Docs2Answers
from crapstack.haystack.nodes.question_generator import QuestionGenerator
from crapstack.haystack.nodes.base import BaseComponent, RootNode
...
class Pipeline:
    ...
    def to_code(
        self, pipeline_variable_name: str = "pipeline", generate_imports: bool = True
    ) -> str:
        """
